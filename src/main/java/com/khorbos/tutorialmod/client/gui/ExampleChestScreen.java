package com.khorbos.tutorialmod.client.gui;
...
public class ExampleChestScreen extends ContainerScreen<ExampleChestContainer> {
    ...
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(TutorialMod.ID, "textures/gui/example_chest.png");
